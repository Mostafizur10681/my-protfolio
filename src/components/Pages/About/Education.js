            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
                <div>
                    ...
                    <div class="card w-full bg-base-100 mb-5 shadow-xl">
                        <div class="card-body">
                            <h2 className='text-2xl pl-10'><FontAwesomeIcon className=' text-2xl pl-2 mr-2' icon={faGraduationCap}></FontAwesomeIcon><span className='font-bold'>BSC in CSE -</span> <span>Daffodil International University</span></h2>
                    ...
                    <div class="card w-full bg-base-100 mb-5 shadow-xl">
                        <div class="card-body">
                            <h2 className='text-2xl pl-10 '><FontAwesomeIcon className=' text-2xl pl-2 mr-2' icon={faGraduationCap}></FontAwesomeIcon><span className='font-bold'>Higher Secondary-</span> <span>Sonar Bangla College</span></h2>
                ...
                <div>
                    <h1 className='text-center font-bold mb-12 text-3xl uppercase'>Extra Carriculam <span className='text-primary'>Activities</span></h1>
                    <div class="card w-full bg-base-100 mb-5 shadow-xl">
                        <div class="card-body">
