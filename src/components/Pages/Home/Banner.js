        ...
        <div class="hero min-h-screen " style={{
            ...
            <div class="hero-content mx-auto  flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <button class="btn btn-primary rounded-full mr-2 text-md text-white"><FontAwesomeIcon className='mr-2' icon={faDownload}></FontAwesomeIcon><a href="https://drive.google.com/file/d/1D3swU42HGXKORtngBiEpYTc3EcDRULEO/view?usp=sharing" target='_blank'>Download Resume</a> </button>
