        ...
        <div class="hero min-h-screen " style={{
            ...
            <div class="hero-content mx-auto  flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <p class="py-6 text-white">This is Md. Mostafizur Rahman. I'm a web designer & MERN Stack developer focused on crafting clean & user‑friendly experiences. My strength is I can learn new technology quickly. I am also a dedicated person.
                    </p>
